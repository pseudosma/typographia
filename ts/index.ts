...
class Game {
    ...
    public CreateScene() : void {
        ...
        //     //for (let i=0; i<rt.sdc.length; i++) {
        //     for (let i=0; i<50; i++) {
        //         fl.InstanceLetter(s, v.sdc.charCodeAt(i).toString(), i);
        //     }
        //     });
        //   });
        ...
        Promise.all(p).then(function() {
            ...
            for (let i=0; i<50; i++) {
                fl.InstanceLetter(s, rt.charCodeAt(i).toString(), i);
            }
          });
