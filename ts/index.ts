...
class Game {
    ...
    public Run(): void {
        this.engine.runRenderLoop(() => {
            ...
            //     if (i == null) {
            //         console.log("instancing letter " + this.text[max] + " at index " + max);
            //         this.fl.InstanceLetter(this.scene, this.text[max], max);
            //     }
            //     if (min > -1) {
            //         var d = this.scene.getMeshByID((min).toString());
            //         if (d != null) {
            //             console.log("deinstancing letter " + this.text[min] + " at index " + min);
            //             this.fl.DeinstanceLetter(this.scene, min);
            //         }
            //     } 
            // }
            // if (this.lastX > x && x <= this.text.length) {
            //     //going left
            //     if (min > -1) {
            //         var i = this.scene.getMeshByID((min).toString());
            //         if (i == null) {
            //             console.log("instancing letter " + this.text[min] + " at index " + min);
            //             this.fl.InstanceLetter(this.scene, this.text[min], min);
            //         }
            //     }
            //     if (max <= this.text.length) {
            //         var d = this.scene.getMeshByID((max).toString());
            //         if (d != null) {
            //             console.log("deinstancing letter " + this.text[max] + " at index " + max);
            //             this.fl.DeinstanceLetter(this.scene, max);
            //         }
            //     }
            // }
            ...
            if (this.lastX > x && x <= this.text.content.length) {
                //going left
                if (min > -1) {
                    var i = this.scene.getMeshByID((min).toString());
                    if (i == null) {
