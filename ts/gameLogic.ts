...
const updateTextPosition = (scene, camera, xPosition, text, fontLoader) => {
...
export class Game implements BabylonGame, TextBasedGame, Configurable {
    ...
    textLoader = new TextLoader(this.config);
    lastX = 0;
    ...
    public CreateScene(): void {
        ...
        // const p = this.fontLoader.LoadFonts(this.scene,this.config.graphicsPath, this.config.fontFile);
        // Promise.all([t, ...p]).then(function() {
